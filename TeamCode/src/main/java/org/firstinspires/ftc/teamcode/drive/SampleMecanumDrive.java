...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.25, 0.25, Math.toRadians(3.0)), 0.5);
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, HardwareConfig.LEFT_FRONT_MOTOR);
        leftRear = hardwareMap.get(DcMotorEx.class, HardwareConfig.LEFT_BACK_MOTOR);
        rightRear = hardwareMap.get(DcMotorEx.class, HardwareConfig.RIGHT_BACK_MOTOR);
        rightFront = hardwareMap.get(DcMotorEx.class, HardwareConfig.RIGHT_FRONT_MOTOR);
